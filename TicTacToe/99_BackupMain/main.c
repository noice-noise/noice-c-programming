...
/*
	...
	*Allows more than 3x3 standard playing field
	*Can implement basic game rules
	*Can verify invalid inputs
*/
int field[MAX][MAX];
...
int inputPlayer (char symbol, int playerSym) 
{
	int value = 0;
	value = symbol;
